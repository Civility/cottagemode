...
function modChrome_default($module, &$params, &$attribs)
{
	...
	$moduleClass   = $bootstrapSize !== 0 ? ' col-lg-' . $bootstrapSize : '';
	...
	if ($module->content)
	{
		echo '<' . $moduleTag . ' class="mod ' . htmlspecialchars($params->get('moduleclass_sfx'), ENT_COMPAT, 'UTF-8') . $moduleClass . ' col-12">';
